...
with open('regressor.pkl', 'rb') as pkl_file:
...
def predict_func():
	...
	cols = ['status', 'baths', 'city', 'sqft', 'zipcode', 'state', 'pool_encoded', 'Type', 'Year built', 'Heating_corr', 'Cooling_corr', 'Parking_corr', 'fireplace_corr', 'school_rating _mean', 'school_distance_min']
	...
	for column in ['baths', 'sqft', 'school_rating _mean', 'school_distance_min']:
